...
func newKeyCmd() *ffcli.Command {
	return &ffcli.Command{
		...
		Subcommands: []*ffcli.Command{newKeyGenerateCmd(), newKeyPublicCmd()},
...
func newKeyGenerateCmd() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "generate",
		ShortUsage: "tsnixcache key generate [--name <name>] > /etc/tsnixcache/key",
...
func newKeyPublicCmd() *ffcli.Command {
	return &ffcli.Command{
		Name:       "public",
		ShortUsage: "tsnixcache key public <key-file>",
