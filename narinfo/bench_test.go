...
const benchNarinfo = `StorePath: /nix/store/s66mzxpvicwklp6nvshjmcarrqdv3s7a-libssh2-1.10.0
URL: nar/0a1m7b1b3j19hpwslxbdlvnmkbn5yxw5bvkh1m0xqmvd73k7naw5.nar.xz
Compression: xz
FileHash: sha256:0a1m7b1b3j19hpwslxbdlvnmkbn5yxw5bvkh1m0xqmvd73k7naw5
FileSize: 98765
NarHash: sha256:1l29f8r5z89560ndabhcj6yylaxihqadm0a37ibfwnr73x5m0b9p
NarSize: 294664
References: 0jqd0rlxzra1rs38rdgwg20128y0f25r-libc-2.34 5qkm48bpgf7gzfm9hcp2cn2b7p4jqnvr-openssl-3.0.8 s66mzxpvicwklp6nvshjmcarrqdv3s7a-libssh2-1.10.0
...
func BenchmarkParse(b *testing.B) {
	...
	for b.Loop() {
		...
		sinkNI, err = Parse(strings.NewReader(benchNarinfo), DefaultStoreDir)
		if err != nil {
			b.Fatal(err)
		}
	}
...
func BenchmarkMarshal(b *testing.B) {
	ni, err := Parse(strings.NewReader(benchNarinfo), DefaultStoreDir)
	if err != nil {
		b.Fatal(err)
	}
